...
function setupPillars() {
  ...
  //set up transcript divs
  div1 = createElement('div', '');
  setDiv(div1, pillar2Left);
  // div.position(transcriptX,this.y[0]);
  // div.style('padding', '10px');
  // div.style('background-color', 'white');
  div1.html('<iframe src="https://embed.lvn.org/?hid=5245480 width="100%" height="425" scrolling="no" frameborder="no" style="max-width: 850px; margin: 0 auto; display: block"></iframe>');
}
